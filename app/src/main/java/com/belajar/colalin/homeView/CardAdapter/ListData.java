...
public class ListData {
    ...
    public static void addData(){
        data.add(new ListMenu("Jalan Toll","Jalan toll satu arah",R.drawable.road,Color.parseColor("#06113C")));
        data.add(new ListMenu("Jalan Raya","Jalan Raya dua arah", R.drawable.motorway,Color.parseColor("#113906")));
        data.add(new ListMenu("Jalan Raya", "Jalan Raya satu arah", R.drawable.one_way, Color.parseColor("#C74B50")));
    }
